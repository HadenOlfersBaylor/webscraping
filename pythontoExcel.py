...
# MY ATTEMPT TO SOLVE
#wsTwo = wb['second Sheet']

#columnA = wsTwo['A']

#for a in columnA:
    #for i in range(1, sheet_1.max_row+1):
        #a.value = sheet_1.cell(i, 1).value

#for i in range(1, sheet_1.max_row+1):
#    wsTwo['B'] = sheet_1.cell(i, 2).value
    
#for i in range(1, sheet_1.max_row+1):
#    wsTwo['C'] = sheet_1.cell(i, 3).value
    
#for i in range(1, sheet_1.max_row+1):
#    wsTwo['D'] = sheet_1.cell(i, 4).value
